          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  但是注意到<Text code>每颗觉醒石的提升量</Text>
                  会随着觉醒英雄增多而导致效果稀释，因此优先级还需要综合考虑
                  <Text code>觉醒石消耗量</Text>
                  <br />
                  <blockquote>
                    即：在<Text code>每颗觉醒石的提升量</Text>
                    大致相当时，消耗了更多觉醒石的组合方案更优质
                  </blockquote>
                </li>
                <Text strong>查看多组提升优先级：</Text>
                <li>
                  考虑到部分缘分的英雄间有重叠，例如
                  <Text code>善花+樱花+巴欧</Text>、<Text code>善花+巴欧</Text>
                  ，单独看各个缘分时收益并不大，但如果两个同时提升一级，则收益会变大
                </li>
                <li>
                  因此自查表提供了多组提升选择框，可以选择一次提升1~5组缘分时的收益情况
                </li>
                <li>
                  由于多组提升的排列组合数巨大，生成的组合方案只考虑相互之间有关联的，且只展示收益最高的100项
                </li>
              </ul>
            </li>
            <li>
