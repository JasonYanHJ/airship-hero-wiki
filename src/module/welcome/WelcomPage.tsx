            ...
            <li>
              ...
              <ul>
                ...
                <blockquote>
                  注意：
                  <li>
                    该功能需要玩家先前往“个人数据”页面录入自己的游戏进度数据，以及在“缘分自查表”页面填写自己的面板暴击伤害
                  </li>
                  <li>
                    如果一次提升多个缘分，由于缘分之间存在重合，觉醒石消耗可能减少，因此有些缘分的实际优先级会更高。例如：“善花+樱花+巴欧”
                    & “善花+巴欧”。
                    <br />
                    (后续开发会考虑这种情况，进一步加强自查表的功能)
                  </li>
                </blockquote>
                ...
                <li>
                  游戏进入补缘分阶段后，主要的资源瓶颈是觉醒石，因此表格按照“每颗觉醒石的提升量”进行排序
                </li>
              </ul>
            </li>
            <li>
