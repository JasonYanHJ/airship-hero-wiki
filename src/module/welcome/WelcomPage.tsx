  ...
  return (
    <PageContainer title={false}>
      <Card>
        ...
        <Paragraph>
          “飞艇Wiki”旨在整合游戏“飞艇英雄”的各类数据与工具，提供一个方便实用的百科全书&工具箱供玩家使用，目前有英雄图鉴、缘分图鉴、玉石最佳方案计算、补缘分自查表等功能。未来可能会整合更多的工具（画饼）。
        </Paragraph>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <Text strong>计算最佳选择方案：</Text>
                <li>你可以设置你的玉石总数、各类奖励的等价钻石价值</li>
                <li>Wiki将根据你的设置，计算出最佳的选择方案</li>
                <li>你可以与原有方案比较，并选择是否应用系统计算得出的方案</li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <Text code>每5颗觉醒石的提升量</Text>进行排序;
                </li>
                <li>
                  由于缘分效果是叠乘，<Text code>每5颗觉醒石的提升量</Text>
                  采用指数方式计算
                  <blockquote>
                    即：(1+<Text code>每5颗觉醒石的提升量</Text>)^
                    <Text code>觉醒石消耗量/5</Text>=实际提升
                  </blockquote>
                </li>
                <li>
                  考虑到部分角色可能暂时无法活动（工会、巴赫、限定），支持在计算时排除指定角色
                </li>
              </ul>
            </li>
            <li>
